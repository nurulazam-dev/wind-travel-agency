...
import mapImg from "../../Assets/images/BookSteps/map.png";
import sendImg from "../../Assets/images/BookSteps/send.png";
import buildingImg from "../../Assets/images/BookSteps/building.png";
import leftImg from "../../Assets/images/BookSteps/leaf.png";
import heartImg from "../../Assets/images/BookSteps/heart.png";
          ...
          <div className="lg:basis-1/2">
            <div class="card card-compact w-96 bg-base-100 shadow-xl">
              <div class="card-body">
                ...
                <div className="m-3">
                  <h3 className="mx-2 text-[18px] font-bold">
                    Trip To Boracay
                  </h3>
